...
interface UnderlayOption {
  label: string;
  value: string;
  /** Optional React component to render a map legend beneath the selected option. */
  legend?: React.ComponentType | null;
  source: Source;
}
...
export const UNDERLAYS: Record<string, UnderlayOption> = {
  STREET: {
    label: 'Street map',
...
export const OVERLAYS: Record<string, OverlayOption> = {
  NONE: {
    label: 'No overlay',
    value: null,
  },
